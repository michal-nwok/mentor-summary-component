...
function Summary() {
  ...
  return (
    <div className="font-grotesk xl:flex xl:flex-row xl:shadow-xl xl:rounded-3xl xl:w-4/5">
      ...
      <section className="p-5 w-full xl:w-3/5 flex flex-col justify-evenly">
          ...
          {scoreData.map((scoreInfo: ScoreInformation) => {
            return (
              <ScoreCard
                ...
                key={scoreInfo.category}
              />
            );
          })}
        </div>

        <button className="w-full bg-dark-gray p-4 rounded-5xl text-white hover:bg-gradient-to-t hover:from-royal-blue hover:to-slate-blue">
          Continue
        </button>
      </section>
    </div>
